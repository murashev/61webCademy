...
// ToDo 8. УРОК. Очистка полей формы после ввода

// ToDo 1) В view создание функции clearFields для очистки полей формы
// ToDo 2) Запуск ф-ии clearFields в контроллере после добавления новых данных

// ToDo 9. УРОК. Проверка на пустые поля

// ToDo 1) Правим контроллер добавляя условие на непустые поля

// ToDo --------------------------------- 1-я часть готова! ------------------------------------